...
class Bridge(object):
    ...
    def addif(self, iname):
        ...
        _runshell(
            [brctlexe, 'addif', self.name, iname],
    ...
    def delif(self, iname):
        ...
        _runshell(
            [brctlexe, 'delif', self.name, iname],
    ...
    def hairpin(self, port, val=True):
        ...
        if val:
            ...
            state = 'off'
        _runshell(
            [brctlexe, 'hairpin', self.name, port, state],
    ...
    def setageing(self, time):
        ...
        _runshell(
            [brctlexe, 'setageing', self.name, str(time)],
    ...
    def setbridgeprio(self, prio):
        ...
        _runshell(
            [brctlexe, 'setbridgeprio', self.name, str(prio)],
    ...
    def setfd(self, time):
        ...
        _runshell(
            [brctlexe, 'setfd', self.name, str(time)],
    ...
    def sethello(self, time):
        ...
        _runshell(
            [brctlexe, 'sethello', self.name, str(time)],
    ...
    def setmaxage(self, time):
        ...
        _runshell(
            [brctlexe, 'setmaxage', self.name, str(time)],
    ...
    def setpathcost(self, port, cost):
        ...
        _runshell(
            [brctlexe, 'setpathcost', self.name, port, str(cost)],
    ...
    def setportprio(self, port, prio):
        ...
        _runshell(
            [brctlexe, 'setportprio', self.name, port, str(prio)],
